...
세미콜론을 찬성하는 사람들은 오류 가능성이있는 불명확성, 가독성 등을 이유로 세미콜론은 필요하다고 주장한다.
...
많은 커뮤니티에서는 세미콜론이 필요없다는 의견 역시 팽팽하다. 이사람들은 ASI를 알고있으면 쓸 필요가 없다, 코드를 덜 써도 된다 등을 이유로 쓰지 않아도 된다고 주장한다.
...
결론은 특별한 이슈가 없는 한 개인적 스타일이다. 이 주제에 대해서는 아직도 의견이 분분하고 진행중이다. 어떤 방식을 선택하든지 일관성있는 코드를 작성하면 될 것 같다.
